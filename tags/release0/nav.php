...
<div id="logo">
<a id="ewwrp" href="http://chaucer.library.emory.edu/wwrp/">
...
<form class="menu" action="frames?contentsrc=search" method="post">
    
<input name="visited" value="true" type="hidden">
    <input name="quantity" value="60" type="hidden"> 
    <input name="content" size="20" value="" align="left" type="text">
...
<ul>
 <li>- <a id="genrefiction" href="genrefiction/">Genre Fiction</a></li>
 ...
 <li>- <a id="nativeamerican" 	href="http://chaucer.library.emory.edu/wwrp/">Native
	American</a></li>
